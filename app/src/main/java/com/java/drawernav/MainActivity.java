...
import com.java.drawernav.ui.gallery.GalleryFragment;
import com.java.drawernav.ui.home.HomeFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent telfon = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:088983013546"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container_view_tag, new GalleryFragment())
                    .commit();
